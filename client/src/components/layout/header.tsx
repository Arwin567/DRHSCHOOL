      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <Link href="/" className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-school-blue">DRS</h1>
              <p className="text-sm text-gray-600">Discipline Resolute High School</p>
            </div>
          </Link>
          ...
          <nav className="hidden lg:flex space-x-8">
            ...
            <NavLink href="/mandatory-disclosure">Mandatory Public Disclosure</NavLink>
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[400px]">
              <nav className="flex flex-col space-y-4 mt-8">
                ...
                <NavLink href="/mandatory-disclosure" className="block py-2">Mandatory Public Disclosure</NavLink>
